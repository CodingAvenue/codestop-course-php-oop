...
class IncorrectAccessToCheckAgePrivateMethodTest extends TestCase
{
    ...
    public function testAssignmentSetAge()
    {
        ...
        $this->assertEquals(1, $nodes->count(), "Expecting one assignment statement inside the `setAge()` method.");
    }
    ...
    public function testReturnGet()
    {
        ...
        $this->assertEquals(1, $nodes->count(), "Expecting one return statement in the `getkAge()` method.");
    }
    ...
    public function testIfCheck()
    {
        ...
        $this->assertEquals(1, $nodes->count(), "Expecting an if statement in the `checkAge()` method.");
    }
    ...
    public function testIfSet()
    {
        ...
        $this->assertEquals(1, $nodes->count(), "Expecting an if statement in the `setAge()` method.");
    }
