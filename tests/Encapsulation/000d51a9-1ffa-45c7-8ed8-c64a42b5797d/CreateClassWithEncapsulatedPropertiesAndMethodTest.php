...
class CreateClassWithEncapsulatedPropertiesAndMethodTest extends TestCase
{
    ...
    public function testTypeValue()
    {
        ...
        $this->assertEquals(1, $dogValue->count(), "Expecting the value 'Dog' assigned to the 'name' property.");
    }
    ...
    public function testSetAgeCall()
    {
        ...
        $this->assertEquals(1, $setAge->count(), "Expecting one 'setAge()' method call of 'pet'.");
    }
    ...
    public function testIsValidCall()
    {
        ...
        $this->assertEquals(1, $isValid->count(), "Expecting one 'isValid()' method call in the `setAge()` method of the `Animal` class itself.");
    }
