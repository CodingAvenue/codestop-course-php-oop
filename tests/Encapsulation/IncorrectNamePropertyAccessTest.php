...
use Proofs\Proof;
class IncorrectNamePropertyAccessTest extends Proof
{
    ...
    public function testPersonObjectVariable()
    {
        ...
        $this->assertEquals(5, $personObject->count(), "Expecting five occurrences of the variable named 'personObject'.");
    }
    ...
    {
        $setName = self::$code->find('method-call[name="setName", variable="personObject"]');

        $this->assertEquals(1, $setName->count(), "Expecting a 'setName()' method call of 'personObject'.");
    }  
