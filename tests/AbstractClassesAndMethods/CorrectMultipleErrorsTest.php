...
class CorrectMultipleErrorsTest extends Proof
{
    ...
    // public function testJohnArg()
    // {
    //     $argTest=self::$code->find('args');
    //     $node = $argTest->getSubnodeByIndex(4);
    //     $node2 = $node->getSubnode();
    //     //$nameVar= $node2->find('literal[value="BSCS"]');
    //     print_r($node2);
    //    // $this->assertEquals(1, $johnArg->count(), "Expecting `John` as argument.");
    // }
