...
class UnspecifiedUserClassNamespaceUserAppTest extends TestCase
{
    ...
    {
        $nodes = self::$code->find('namespace[name="App"]');

        $this->assertEquals(1, $nodes->count(), "Expecting an `App` namespace definition.");
    }   
} 