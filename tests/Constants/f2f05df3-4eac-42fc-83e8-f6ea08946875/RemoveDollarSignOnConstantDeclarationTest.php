...
class RemoveDollarSignOnConstantDeclarationTest extends TestCase
{
    ...
    public function testDisplayCall()
    {
        ...
        $this->assertEquals(1, $display->count(), "Expecting one 'display()' method call of 'circle'.");
    }
    ...
    public function testRadiusPropertyCallDis()
    {
        ...
        $this->assertEquals(1, $radius->count(), "Expecting one `radius` property call in the `display()` method of the `Circle` class itself.");
    }
    ...
    public function testRadiusPropertyCallGetRad()
    {
        ...
        $this->assertEquals(1, $radius->count(), "Expecting one `radius` property call in the `getRadius()` method of the `Circle` class itself.");
    }
    ...
    public function testRadiusPropertyCallArea()
    {
        ...
        $this->assertEquals(2, $radius->count(), "Expecting two `radius` property calls in the `area()` method of the `Circle` class itself.");
    }
