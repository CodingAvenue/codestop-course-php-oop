...
class RemoveVisibilityKeywordOnConstantDeclarationCircleTest extends TestCase
{
    ...
    public function testActualCode() // this still generate an error but I cannot indentify what is the cause of the error
    {
